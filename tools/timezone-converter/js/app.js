...
import { initializeTimezoneSelects, initializeTheme, setupEventListeners } from './ui.js';
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function initializeMeetingPlanner(elements, config) {
    // 参加者のタイムゾーンセレクトを設定
    const participantTimezonesSelects = document.querySelectorAll('.participant-timezone');
   ...
   */
  function populateTimezoneSelect(selectElement, timezones, selectedValue = null) {
    // 既存のオプションをクリア
